    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 30px; font-family: Times New Roman;">QUEMA FÍSICA</h1>
            </div>
            <div class="container">
                    ...
                    <div >
                        ...
                        <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                            <tr>
                                <th></th>
                                <th>Fecha</th>
                                <th>Cantidad Mano de Obra</th>
                                <th>Valor Mano de Obra</th>
                                <th>Valor Total</th>
                            </tr>    
                            <c:forEach items="${ListaQuemaFisica}" var="Lista">
                                <tr>
                                <td><input type="radio" name="id" id="id_${Lista.id_qf}" value="${Lista.id_qf}"/></td>
                                <td>${Lista.fecha_qf}</td>
                                <td>${Lista.cantidad_jornales_qf}</td>
                                <td>${Lista.valor_unidad_jornal_qf}</td>
                                <td>${Lista.valor_total_jornal_qf}</td>
        ...
        <div style="text-align: center; padding: 20px;">
            <h1 style="font-size: 30px; font-family: Times New Roman;">INSUMOS QUEMA FÍSICA</h1>
        </div>
        <div class="container">
            <div class="table"  style="margin-left: -65px; font-size: 18px; font-family: Times New Roman;" >
                <table class="table  table-hover table-bordered table-condensed">
                    ...
                    <c:forEach items="${ListaQuemaFisica}" var="Lista">
                <tr>
                <td>${Lista.cantidad_insumos_qf}</td>
                <td>${Lista.unidad_insumo_qf}</td>
                <td>${Lista.valor_unitario_insumo_qf}</td>
                <td>${Lista.valor_total_insumo_qf}</td>
                <td>${Lista.valor_total_qf}</td>
            </tr>
            </c:forEach>
                </table>
            </div>
        ...
        <div align="center">
            ...
            <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteQuemaFisica" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
        </div>
    </div>

<%-- 
    Document   : fumigas3
    Created on : 6/10/2016, 08:04:54 PM
    Author     : LUIS
--%>
...
<html>
 ...
 <head>
        ...
        <title>Fumiga 3</title>
        <%
            session.setAttribute("nombre_fumiga", "fumiga 3");
        %>
    </head>
    <body class="fondo">
        <div id="toplogo">
        ...
        <div id="contenedor">
            <form action="Fumigas" id="Fumigas" method="post" id="data">
                <div id="cuerpo">
                    ...
                    <h1 style="margin-top: 50px; font-size: 28px; font-family: Times New Roman;">FUMIGA 3</h1>

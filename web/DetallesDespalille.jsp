    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 30px; font-family: Times New Roman;">DESPALILLE</h1>
            </div>
            ...
            <div class="container">
                <div class="table"  style="margin-left: -65px;" >
                    ...
                    <c:forEach items="${ListaDespalille}" var="Lista">
                        <tr>
                            <td><input type="radio" name="id" id="id_${Lista.id_dsp}" value="${Lista.id_dsp}"/></td>
                            <td>${Lista.fecha_dsp}</td>
                            <td>${Lista.cantidad_mano_obra_dsp}</td>
                            <td>${Lista.precio_mano_obra_dsp}</td>
                            <td>${Lista.total_mano_obra_dsp}</td>
            ...
            <div align="center">
                ...
                <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteDespalille" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
            </div>
        </div>

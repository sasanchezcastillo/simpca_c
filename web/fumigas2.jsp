<%-- 
    Document   : fumigas2
    Created on : 6/10/2016, 08:04:44 PM
    Author     : LUIS
--%>
...
<html>
  ...
  %>
    ...
    <head>
        ...
        <title>Fumiga 2</title>
        <%
            session.setAttribute("nombre_fumiga", "fumiga 2");
        %>
    </head>
    <body class="fondo">
        <div id="toplogo">
        ...
        <div id="contenedor">
            <form action="Fumigas" id="Fumigas" method="post" id="data">
                <div id="cuerpo">
                    ...
                    <h1 style="margin-top: 50px; font-size: 28px; font-family: Times New Roman;">FUMIGA 2</h1>

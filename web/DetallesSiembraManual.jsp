    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 30px; font-family: Times New Roman;">SIEMBRA MANUAL</h1>
            </div>
            <div class="container">
                    ...
                    <div >
                        ...
                        <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                            <tr class="active">
                                ...
                                <th >Valor Bulto </th>
                                <th>Valor Total Obreros</th>
                                <th >Costo Secado Semilla</th>
                            </tr>
                            <c:forEach items="${ListaSiembraManual}" var="Lista">
                                <tr>
                                    <td><input type="radio" name="id" id="id_${Lista.id_sim}" value="${Lista.id_sim}"/></td>
                                    <td>${Lista.fecha_sim}</td>
                                    <td>${Lista.variedad_semilla_sim}</td>
                                    <td>${Lista.cantidad_bultos_sim}</td>
                                    <td>${Lista.precio_bulto_sim}</td>
                                    <td>${Lista.pago_total_obreros_sim}</td>
                                    <td>${Lista.costo_secado_semilla_sim}</td>
                ...
                <div class="table"  style="margin-left: -65px;" >
                    <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                        <tr class="active">
                            ...
                            <th>Valor Total Siembra</th>
                        </tr>
                        <c:forEach items="${ListaSiembraManual}" var="Lista">
                            <tr class="active">
                                <td>${Lista.costo_transporte_sim}</td>
                                <td>${Lista.costo_semilla_sim}</td>
                                <td>${Lista.valor_total_sim}</td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
            ...
            <div align="center">
                ...
                <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteSiembraManual" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
            </div>
        </div>

 ...
 * @author LENOVO
 */
public class Lote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        seleccionLote con = new seleccionLote();
        lo = con.getContactos(cedula);
 
        request.setAttribute("lista", new Controladores.seleccionLote().getContactos(cedula));
        request.getRequestDispatcher("administrador/seleccioneLote.jsp").forward(request, response);

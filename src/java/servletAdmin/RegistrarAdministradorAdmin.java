 ...
 * @author LENOVO
 */
public class RegistrarAdministradorAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (co.ReistrarAdministrador(cedula, nombre, apellido, contrasena, sexo, telefono, correo, direccion,tipo))
        {

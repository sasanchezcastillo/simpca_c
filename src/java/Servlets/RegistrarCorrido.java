 ...
 * @author LENOVO
 */
public class RegistrarCorrido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession objeSession = request.getSession();
                
        String fecha = request.getParameter("fecha");
        String tipo_riego = (String) objeSession.getAttribute("tipo_riego");
        ...
        String valorTarifaDistricto = request.getParameter("valorTarifa").replace(".", "");
        String total = request.getParameter("total").replace(".", "");
        
        System.err.println("error");
        ConsultasSQL co = new ConsultasSQL();
        System.err.println("entro");
        if (co.registrarCorrido(fecha, tipo_riego, numLote, cantidadManoObra, valorManoObra, totalManoObra, valorTarifaDistricto, total)) {
            response.sendRedirect("Corrido1.jsp");

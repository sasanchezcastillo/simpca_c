 ...
 * @author LENOVO
 */
public class ReportePreparacionSuelo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                rs2 = st2.executeQuery("SELECT * from preparacion_suelo where num_lote ='" + num_lote + "'");
                rs3 = st3.executeQuery("SELECT * from preparacion_suelo where num_lote ='" + num_lote + "'");
                if (con != null) {
...
try {
                        ...
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase("REPORTE PREPARACIÓN DE SUELO", fonttitulo));
                        ...
                        PdfPCell celda2 = new PdfPCell(new Paragraph("Tipo de Preparación", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda3 = new PdfPCell(new Paragraph("Cantidad Hectáreas", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda4 = new PdfPCell(new Paragraph("Pases", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        PdfPCell celda5 = new PdfPCell(new Paragraph("Valor Unidad", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        PdfPCell celda6 = new PdfPCell(new Paragraph("Valor Total", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        ...
                        while (rs2.next()) {
                            ...
                            tabla.addCell(rs2.getString("fecha_preparacions"));
                            tabla.addCell(rs2.getString("tipo_preparacions"));
                            tabla.addCell(rs2.getString("cantidad_hect_horas_preparacions"));
                            tabla.addCell(rs2.getString("pases_preparacions"));
                            tabla.addCell(rs2.getString("valor_unitario_preparacions"));
                            tabla.addCell(rs2.getString("valor_total_preparacions"));

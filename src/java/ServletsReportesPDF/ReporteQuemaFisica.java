 ...
 * @author LENOVO
 */
public class ReporteQuemaFisica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                rs2 = st2.executeQuery("SELECT * from quema_fisica where num_lote ='" + num_lote + "'");
                rs3 = st3.executeQuery("SELECT * from quema_fisica where num_lote ='" + num_lote + "'");
                if (con != null) {
                   ...
                   FooterPiePaginaiText footer = new FooterPiePaginaiText();
                    ...
                    try {
                        ...
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase("REPORTE QUEMA FISICA", fonttitulo));
                        ...
                        PdfPCell celda2 = new PdfPCell(new Paragraph("Cantidad Mano de Obra", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda3 = new PdfPCell(new Paragraph("Valor Mano de Obra", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda4 = new PdfPCell(new Paragraph("Valor Total", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        ...
                        while (rs2.next()) {
                            ...
                            tabla.addCell(rs2.getString("fecha_qf"));
                            tabla.addCell(rs2.getString("cantidad_jornales_qf"));
                            tabla.addCell(rs2.getString("valor_unidad_jornal_qf"));
                            tabla.addCell(rs2.getString("valor_total_jornal_qf"));
                        ...
                        par4.add(new Phrase("REPORTE INSUMOS QUEMA FISICA", fontFooter2));
                        ...
                        FontFactory.registerDirectories();
                        PdfPCell celda10 = new PdfPCell(new Paragraph("Cantidad", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda10.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda20 = new PdfPCell(new Paragraph("Unidad", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda20.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda30 = new PdfPCell(new Paragraph("Valor Unitario", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda30.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda40 = new PdfPCell(new Paragraph("Valor Total", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda40.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda50 = new PdfPCell(new Paragraph("Costo Total ", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        ...
                        while(rs3.next()){
                            tabla2.addCell(rs3.getString("cantidad_insumos_qf"));
                            tabla2.addCell(rs3.getString("unidad_insumo_qf"));
                            tabla2.addCell(rs3.getString("valor_unitario_insumo_qf"));
                            tabla2.addCell(rs3.getString("valor_total_insumo_qf"));
                            tabla2.addCell(rs3.getString("valor_total_qf"));
                        }

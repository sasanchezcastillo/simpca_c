 ...
 * @author LENOVO
 */
public class ReportePajareoCeladuria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                rs2 = st2.executeQuery("SELECT * from pajareo_celaduria_patos where num_lote ='" + num_lote + "'");
                rs3 = st3.executeQuery("SELECT * from pajareo_celaduria_patos where num_lote ='" + num_lote + "'");
                if (con != null) {
                   ...
                   FooterPiePaginaiText footer = new FooterPiePaginaiText();
                    ...
                    try {
                        ...
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase(Chunk.NEWLINE));
                        par1.add(new Phrase("REPORTE PAJAREO Y CELADURÍA DE PATOS", fonttitulo));
                        ...
                        PdfPCell celda2 = new PdfPCell(new Paragraph("Cantidad Jornales", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda3 = new PdfPCell(new Paragraph("Valor Jornal", FontFactory.getFont("Times New Roman", 12,
                                Font.BOLD, BaseColor.BLACK)));
                        PdfPCell celda4 = new PdfPCell(new Paragraph("Valor Total Jornales", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        ...
                        while (rs2.next()) {
                            ...
                            tabla.addCell(rs2.getString("fecha_pcp"));
                            tabla.addCell(rs2.getString("cantidad_mano_obra_pcp"));
                            tabla.addCell(rs2.getString("valor_mano_obra_pcp"));
                            tabla.addCell(rs2.getString("valor_total_mano_obra_pcp"));
                        ...
                        par4.add(new Phrase("REPORTE INSUMOS PAJAREO Y CELADURÍA DE PATOS", fontFooter2));
                        ...
                        FontFactory.registerDirectories();
                        PdfPCell celda10 = new PdfPCell(new Paragraph("Cantidad Pólvora", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda10.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda20 = new PdfPCell(new Paragraph("Valor Pólvora", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda20.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda30 = new PdfPCell(new Paragraph("Valor Total Pólvora", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        celda30.setHorizontalAlignment(Element.ALIGN_CENTER);
                        PdfPCell celda40 = new PdfPCell(new Paragraph("Costo Total", FontFactory.getFont("Times New Roman", 12, Font.BOLD,
                                BaseColor.BLACK)));
                        ...
                        while(rs3.next()){
                            tabla2.addCell(rs3.getString("cantidad_polvora_pcp"));
                            tabla2.addCell(rs3.getString("valor_polvora_pcp"));
                            tabla2.addCell(rs3.getString("valor_total_polvora_pcp"));
                            tabla2.addCell(rs3.getString("valor_total_pcp"));
                        }

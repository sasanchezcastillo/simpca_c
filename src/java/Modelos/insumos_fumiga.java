...
public class insumos_fumiga {
   private String tipo_insumo;
    ...
    public insumos_fumiga() {
    }

    public insumos_fumiga(String tipo_insumo, String nombre_insumo, String cantidad_insumo, String unidad_insumo, String valor_unitario_insumo, String valor_total_insumos) {

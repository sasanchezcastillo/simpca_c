    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 30px; font-family: Times New Roman;">QUEMA QUÍMICA</h1>
            </div>
            <div class="container">
                <div class="table" style="margin-left: -65px; font-size: 18px; font-family: Times New Roman;" >
                    <div >
                        ...
                        <table class="table  table-hover table-bordered table-condensed" >
                            ...
                            <c:forEach items="${ListaQuemaQuimica}" var="Lista">

                                <tr>
                                    <td><input type="radio" name="id" id="id_${Lista.id_quemaq}" value="${Lista.id_quemaq}"/></td>
                                    <td>${Lista.fecha_quemaq}</td>
                                    <td>${Lista.cantidad_mano_obra_quemaq}</td>
                                    <td>${Lista.valor_mano_obra_quemaq}</td>
                                    <td>${Lista.valor_total_mano_obra_quemaq}</td>
                                    <td>${Lista.valor_total_quemaq}</td>
            ...
            <div style="text-align: center; padding: 20px;">
                <h1 style="font-size: 30px; font-family: Times New Roman;">INSUMOS QUEMA QUÍMICA</h1>
            </div>
            <div class="container">
                <div class="table"  style="margin-left: -65px; font-size: 18px; font-family: Times New Roman;" >
                    <table class="table  table-hover table-bordered table-condensed">
                        ...
                        <c:forEach items="${insumos_quema_quimicas}" var="Lista">
                            <tr>
            ...
            <div align="center">
                ...
                <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteQuemaQuimica" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
            </div>
        </div>
    </body>

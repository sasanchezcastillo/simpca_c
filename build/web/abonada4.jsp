...
<%
    session.setAttribute("Abonada", "Abonada4");
%>
            ...
            <div id="cont">
                <form action="Abonadas" id="Abonadas" method="post">
                    <div align="center"><br>
                        ...
                        <h1 style="margin-top: 50px; font-size: 28px; font-family: Times New Roman;">ABONADA 4</h1>
                    ...
                    <table border="0" align="center" id="tablaPre-abonada2"  >
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <input type="text" class="textbox" style="background-color:#CCC" id="costoTotalManoObra" name="costoTotalManoObra" onkeyup="format(this); calcularManoObra()" onchange="format()"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">
                                <input type="text" class="textbox" style="background-color:#CCC" id="costoTotalTransporte" name="costoTotalTransporte" onkeyup="format(this); calcularTransporte()" onchange="format()"/>
                            </td>
                        </tr>
                        <tr style="height: 60px;">
                            ...
                            <td align="center">
                                <input type="text" class="textbox" style="background-color:#CCC" id="sumaTotal" name="sumaTotal" onkeyup="format(this)" onchange="calcularTotales(this, 0); format(this)"/>
                            </td>
                        </tr>
                    </table> 

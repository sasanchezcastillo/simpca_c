    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 32px; font-family: Times New Roman;">MACHETEADA</h1>
            </div>
                ...
                <div class="table"  style="margin-left: -65px;" >
                    ...
                    <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                        <tr class="active">
                            ...
                            <th>Valor Unitario Jornal</th>
                            <th>Valor Total</th>
                        </tr>
                    <c:forEach items="${ListaMacheteada}" var="Lista">
                        <tr>
                            <td><input type="radio" name="id" id="id_${Lista.id_mchd}" value="${Lista.id_mchd}"/></td>
                            <td>${Lista.fecha_mchd}</td>
                            <td>${Lista.cantidad_mano_obra_mchd}</td>
                            <td>${Lista.precio_mano_obra_mchd}</td>
                            <td>${Lista.total_mano_obra_mchd}</td>
            ...
            <div align="center">
                ...
                <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteMacheteada" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
            </div>
        </div>

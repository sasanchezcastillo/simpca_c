<%-- 
    Document   : InicioCoagronorte
    Created on : 1/11/2016, 10:55:25 AM
    Author     : LENOVO
--%>
...
<html>
    ...
    <body class="fondoS">
                ...
                <section>
                        <nav>
                                <ul>
                                    ...
                                    <li><a href="#">Blog</a>
                                    <li><a href="Inicio_sesion.jsp">Ingresar</a>
                                </ul>
                        </nav>
                </section>
        </header>
        ...
        <form action="RegistroDME" method="post"> 
                <div id="contenedorMR" align="center">
                    <br> <br> <br>
                   <h1>BIENVENIDO</h1>
                </div>
            </form>  

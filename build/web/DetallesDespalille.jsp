    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div align="center">
                ...
                <form  name="formulario_reporte_despalille" target="_blanck" style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteDespalille" method="POST"> 
                    <input type="text" name="num_lote" hidden="" value="<%=lote%>"> 
                    <font>
...
<script type="text/javascript">
    function redireccionar(){
        document.formulario_reporte_despalille.submit();
    }
        function eliminar(){

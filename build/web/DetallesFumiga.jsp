    ...
    <body class="fondoC">
        ...
        <div style="background: RGBA(245,178,53,0.2); border: solid;border-width: 1px; width: 90%; height:auto;
            ...
            <div style="text-align: center; margin-top: 20px; padding: 20px;">
                ...
                <h1 style="font-size: 35px; font-family: Times New Roman;">FUMIGAS</h1>
            </div>
                    ...
                    <div >
                        ...
                        <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                            <tr class="active">
                                <th></th>
                                <th>Fecha</th>
                                <th>Tipo De Fumiga</th>
                                <th>Cantidad Jornales</th>
                                <th>Valor Por Jornal</th>
                                <th>Valor Total</th>
                            </tr>
                        <c:forEach items="${ListaFumiga}" var="Lista">
                            <tr>
                                <td><input type="radio" name="id" id="id_${Lista.id_fumiga}" value="${Lista.id_fumiga}"/></td>
                                <td>${Lista.fecha_fumiga}</td>
                                <td>${Lista.nombre_fumiga_fumiga}</td>
                                <td>${Lista.cantidad_mano_obra_fumiga}</td>
                                <td>${Lista.valor_uni_mano_obra_fumiga}</td>
                                <td>${Lista.valor_total_mano_obra_fumiga}</td>
            ...
            <div style="text-align: center; padding: 20px;">
                <h1 style="font-size: 30px; font-family: Times New Roman;">INSUMOS FUMIGA</h1>
            </div>
            <div class="container">
                <div class="table"  style="margin-left: -65px;" >
                    <table class="table  table-hover table-bordered table-condensed" style="font-size: 18px; font-family: Times New Roman;">
                    ...
                    <c:forEach items="${insumo_fumiga}" var="Lista">
                        <tr>
            ...
            <div align="center">
                ...
                <form style="margin-top: -120px; margin-left: 300px; width: 100%;" action="ReporteFumigas" method="POST"><input type="text" name="num_lote" hidden="" value="<%=lote%>"><font><input style="font-size: 14px; font-family: Times New Roman;" class="agregar-insumoC" type="submit" value="GENERAR PDF"></form>
            </div>
        </div>
    </body>

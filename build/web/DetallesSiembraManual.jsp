...
<script type="text/javascript">
    function redireccionar(){
        document.formulario_reporte_siembram.submit();
    }
        function eliminar(){

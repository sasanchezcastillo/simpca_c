...
var validarInputs = function(){
	...
	if (elementos.pass.value !== elementos.pass2.value) {
		...
		elementos.pass.className = elementos.pass.className.replace(" error", "cotraseñas");
		elementos.pass2.className = elementos.pass2.className.replace(" error", "contraseñas");
	}
...
var validarCheckbox = function(){
	var opciones = document.getElementsByName('termino'),
		resultado = false;

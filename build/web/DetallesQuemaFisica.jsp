...
<script type="text/javascript">
     function redireccionar(){
        document.formulario_reporte_fisica.submit();
    }
        function eliminar(){

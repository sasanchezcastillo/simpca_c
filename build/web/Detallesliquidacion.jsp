...
<script type="text/javascript">
     function redireccionar(){
        document.formulario_reporte_liqui.submit();
    }
        function eliminar(){
